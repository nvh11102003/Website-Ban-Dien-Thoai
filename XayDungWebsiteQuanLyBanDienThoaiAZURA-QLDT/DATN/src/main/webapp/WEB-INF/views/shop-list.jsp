                        ...
                        <div class="col-12">
                            <div class="main_menu_inner">
                                <div class="main_menu d-none d-lg-block">
                                    <nav>
                                        <ul>
                                            <li class="active"><a href="/home_clients/${kh.maKhachHang}">Home</a>
                                            </li>
                                            <li><a href="/hien-thi-shop/${kh.maKhachHang}">Smartphones</a>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb_content">
                            <ul>
                                <li><a href="/home_clients/${kh.maKhachHang}">home</a></li>
                        ...
                        <div class="shop_toolbar list_toolbar mb-35">
                            <div class="list_button">
                                <ul class="nav" role="tablist">
                                    <li>
                                        <a data-toggle="tab" href="#large" role="tab" aria-controls="large"
                                           aria-selected="true"><i class="fa fa-th-large"></i></a>
                                    </li>
                                    <li>
                                        <a class="active" data-toggle="tab" href="#list" role="tab"
                                            ...
                                            <div class="single_product">
                                                ...
                                                <div class="product_content">
                                                    ...
                                                    <h3 class="product_title"><a
                                                            href="single-product.html">Curabitur sodales</a></h3>
                                                </div>
                                                <div class="product_info">
                                                    <ul>
                                                        <li><a href="#" title=" Add to Wishlist ">Add to
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-8 col-md-6 col-sm-6">
                                                <div class="list_product_content">
                                                    ...
                                                    <div class="list_title">
                                                        <h3><a href="single-product.html">Quisque ornare dui</a>
                                                        </h3>
                                                    </div>
                                                    <p class="design"> in quibusdam accusantium qui nostrum
                                                        consequuntur, officia, quidem ut placeat. Officiis, incidunt
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-8 col-md-6 col-sm-6">
                                                <div class="list_product_content">
                                                    ...
                                                    <div class="list_title">
                                                        <h3><a href="single-product.html">Sed non luctus turpis</a>
                                                        </h3>
                                                    </div>
                                                    <p class="design"> in quibusdam accusantium qui nostrum
                                                        consequuntur, officia, quidem ut placeat. Officiis, incidunt
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-8 col-md-6 col-sm-6">
                                                <div class="list_product_content">
                                                    ...
                                                    <div class="list_title">
                                                        <h3><a href="single-product.html">Donec dignissim eget</a>
                                                        </h3>
                                                    </div>
                                                    <p class="design"> in quibusdam accusantium qui nostrum
                                                        consequuntur, officia, quidem ut placeat. Officiis, incidunt
